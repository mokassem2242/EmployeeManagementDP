-- Rollback sp_Employee_Search Stored Procedure to Original Version
-- This script reverts the sp_Employee_Search stored procedure back to its original simple version
...
-- Create the original simple version
...
PRINT 'sp_Employee_Search stored procedure rolled back to original simple version!'
GO
