        ...
        <style>
            * {
            ...
            body {
                ...
                background: linear-gradient(135deg, #a7d6bd 0%, #ffffff 100%);
                min-height: 100vh;
                display: flex;
                align-items: center;
            ...
            .register-container::before {
                ...
                right: 0;
                height: 4px;
                background: linear-gradient(90deg, #007a3e, #005d2e);
            }
            ...
            .btn-register {
                width: 100%;
                padding: 14px;
                background: linear-gradient(135deg, #007a3e 0%, #005d2e 100%);
                color: white;
                border: none;
                border-radius: 10px;
                font-size: 16px;
            ...
            .btn-register:hover {
                background: linear-gradient(135deg, #005d2e 0%, #007a3e 100%);
                transform: translateY(-2px);
                box-shadow: 0 8px 20px rgba(0, 122, 62, 0.3);
            }
